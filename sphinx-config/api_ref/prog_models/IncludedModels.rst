Included Models
=================== 
The :py:mod:`prog_models`` package is distributed with a few pre-constructed models that can  be used in simulation or prognostics (with the :py:mod:`prog_algs` package). These models are summarized in the following sections.
