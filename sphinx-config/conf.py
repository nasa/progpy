...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', "sphinx.ext.githubpages", 'sphinx.ext.napoleon', 'sphinx.ext.intersphinx', 'sphinx_toolbox.collapse', 'sphinx_toolbox.shields']
