...
class DictLikeMatrixWrapper:
    ...
    def matrix(self) -> np.array:
        ...
        """
        warn(
            "Matrix will be deprecated after version 1.5 of ProgPy. When using for matrix multiplication, please use .dot function. e.g., c.dot(np.array([1, 2, 3])).",
            DeprecationWarning,
            stacklevel=2,
        )
        return self._matrix
    ...
    def frame(self) -> pd.DataFrame:
        ...
        """
        warn(
            "frame will be deprecated after version 1.5 of ProgPy.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def __iter__(self):
        ...
        """
        warn(
            "After v1.5, iteration will iterate through values instead of keys. Please iterate through keys directly (e.g., for k in s.keys())",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def __eq__(self, other: "DictLikeMatrixWrapper") -> bool:
        ...
        """
        warn(
            "Behavior of '==' operator will change after version 1.5 of ProgPy. New behavior will return element wise equality as a new series. To check if two Containers are equal use container.equal(other).",
            DeprecationWarning,
        )
    ...
    def __hash__(self):
        ...
        """
        warn(
            "hash will be deprecated after version 1.5 of ProgPy, will be replace with pandas.util.hash_pandas_object.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def values(self) -> np.array:
        ...
        """
        warn(
            "After v1.5, values will be a property instead of a function.",
            DeprecationWarning,
            stacklevel=2,
        )
        if (
