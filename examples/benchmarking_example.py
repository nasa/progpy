...
Method: An instance of the BatteryCircuit model in progpy is created, state estimation is set up with a chosen state_estimator, and prediction is set up with a chosen predictor.
...
def run_example():
    ...
    for sample_count in sample_counts:
        ...
        pred_results = pred.predict(
            state_estimator.x, future_loading, n_samples=sample_count
        )
        ...
        print(
            "\tRMSE:     {:4.2f}s".format(metrics.root_mean_square_error(toe, 3005.4))
        )
