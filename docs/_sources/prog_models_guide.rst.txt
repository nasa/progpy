...
Data Model Examples
******************************
Data-driven models, such as those using neural networks, are defined by subclassing the :py:class:`prog_models.data_models.DataModel` class. The :py:func:`prog_models.data_models.DataModel.from_data` and :py:func:`prog_models.data_models.DataModel.from_model` methods are used to construct new models. The use of these is demonstrated in the following examples.
...
.. collapse:: Advanced features in data-models
