...
def run_example():
    ...
    TEST_SAMPLES = m_surrogate.parameters["J"].sample(
        size=N_TEST_CASES, rule="latin_hypercube"
    )
    for i in range(N_TEST_CASES):
        # Generate a new loading profile
        interpolator = sp.interpolate.interp1d(
            m_surrogate.parameters["times"], TEST_SAMPLES[:, i]
        )
