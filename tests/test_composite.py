...
class TestCompositeModel(unittest.TestCase):
    ...
    def test_composite_function(self):
        ...
        self.assertSetEqual(
            ...
            {
                "OneInputOneOutputNoEventLM.u1",
                "OneInputOneOutputNoEventLM_2.u1",
                "function.u0",
                "function.u1",
            },
        )
        ...
        u = m_composite.InputContainer(
            {
                ...
                "OneInputOneOutputNoEventLM_2.u1": 0,
                "function.u0": 3,
                "function.u1": 8,
            }
        )
        ...
        self.assertSetEqual(
            m_composite.inputs, {"OneInputOneOutputNoEventLM.u1", "function.u1"}
        )
        self.assertSetEqual(
            m_composite.outputs,
            {
    ...
    def test_parameter_passthrough(self):
        ...
        self.assertEqual(
            m_composite.parameters["models"][0][1].parameters["process_noise"]["x1"],
            2.5,
        )
    ...
    def test_composite_pm(self):
        ...
        m_composite = CompositeModel(
            [m, m],
            connections=[
                ("OneInputOneOutputOneEventLM_2.pm1", "OneInputOneOutputOneEventLM.u1")
            ],
        )
        self.assertSetEqual(
            m_composite.states,
            {
                "OneInputOneOutputOneEventLM_2.pm1",
                "OneInputOneOutputOneEventLM.x1",
                "OneInputOneOutputOneEventLM_2.x1",
            },
        )
        self.assertSetEqual(
            m_composite.inputs,
            {
                "OneInputOneOutputOneEventLM_2.u1",
            },
        )
        x0 = m_composite.initialize()
        ...
        self.assertAlmostEqual(
            x["OneInputOneOutputOneEventLM.x1"], 3
        )  # extra 1 from pm
    ...
    def test_composite_copy(self):
        ...
        self.assertSetEqual(
            m_composite.performance_metric_keys,
            m_composite_copy.performance_metric_keys,
        )
...
def main():
    ...
    result = runner.run(
        load_test.loadTestsFromTestCase(TestCompositeModel)
    ).wasSuccessful()
