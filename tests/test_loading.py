...
class Testloading(unittest.TestCase):
    ...
    def test_wedge_gaussian_load(self):
        ...
        self.assertEqual(loading_with_noise(0), loading_with_noise(0))

        # At any greater time, the standard deviation is not 0
        self.assertNotEqual(loading_with_noise(10), loading_with_noise(10))
        ...
        self.assertEqual(  # Case t<t0
            loading_with_noise(5), loading_with_noise(5)
        )
        self.assertEqual(  # Case t==t0
            loading_with_noise(10), loading_with_noise(10)
        )
        self.assertNotEqual(  # Case t > t0
            loading_with_noise(11), loading_with_noise(11)
        )
