...
from progpy.models.test_models.other_models import (
    OneInputTwoOutputsOneEvent,
    OneInputTwoOutputsOneEvent_alt,
)
...
class TestMoE(unittest.TestCase):
    ...
    def testSameModel(self):
        ...
        self.assertSetEqual(
            set(m_moe.inputs),
            set(OneInputTwoOutputsOneEvent.inputs + OneInputTwoOutputsOneEvent.outputs),
        )
        ...
        self.assertSetEqual(
            set(m_moe.states),
            {
                "OneInputTwoOutputsOneEvent.x0",
                "OneInputTwoOutputsOneEvent_2.x0",
                "OneInputTwoOutputsOneEvent_3.x0",
                "OneInputTwoOutputsOneEvent._score",
                "OneInputTwoOutputsOneEvent_2._score",
                "OneInputTwoOutputsOneEvent_3._score",
            },
        )
        ...
        x = m_moe.next_state(
            x,
            m_moe.InputContainer(
                {  # Input corresponding to _2
                    "u0": 2,
                    "x0+b": 5.76,
                    "x0+c": 5.0,
                }
    ...
    def test_heterogeneous_models(self):
        ...
        self.assertSetEqual(
            set(m_moe.inputs),
            set(
                OneInputTwoOutputsOneEvent.inputs
                + OneInputTwoOutputsOneEvent.outputs
                + OneInputTwoOutputsOneEvent_alt.outputs
            ),
        )
        self.assertSetEqual(
            set(m_moe.outputs),
        ...
        self.assertSetEqual(
            set(m_moe.events),
            set(
                OneInputTwoOutputsOneEvent.events
                + OneInputTwoOutputsOneEvent_alt.events
            ),
        )
        self.assertSetEqual(
            set(m_moe.states),
            {
                "OneInputTwoOutputsOneEvent.x0",
                "OneInputTwoOutputsOneEvent_2.x0",
                "OneInputTwoOutputsOneEvent_alt.x0",
                "OneInputTwoOutputsOneEvent._score",
                "OneInputTwoOutputsOneEvent_2._score",
                "OneInputTwoOutputsOneEvent_alt._score",
            },
        )
        ...
        x["OneInputTwoOutputsOneEvent_alt.x0"] = (
            20  # Will only effect the state for model 3
        )
        tm = m_moe.threshold_met(x)
        self.assertFalse(tm["x0==10"])
